...
QBCore.Functions.CreateCallback('qb-mechanicjob:server:GetDrivingDistances', function(source, cb)
...
QBCore.Functions.CreateCallback('qb-mechanicjob:server:IsVehicleOwned', function(source, cb, plate)
    local retval = false
...
QBCore.Functions.CreateCallback('qb-mechanicjob:server:GetAttachedVehicle', function(source, cb)
    cb(Config.Plates)
end)

QBCore.Functions.CreateCallback('qb-mechanicjob:server:IsMechanicAvailable', function(source, cb)
    local amount = 0
...
QBCore.Functions.CreateCallback('qb-mechanicjob:server:GetStatus', function(source, cb, plate)
